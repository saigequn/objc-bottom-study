...
GETSECT(_getObjc2ClassList,           classref_t const,      "__objc_classlist"); // 主要是用在访问 Objective-C 的类列表
GETSECT(_getObjc2StubList,            stub_class_t *const,   "__objc_stublist");
GETSECT(_getObjc2NonlazyClassList,    classref_t const,      "__objc_nlclslist");
GETSECT(_getObjc2CategoryList,        category_t * const,    "__objc_catlist"); // 用于访问 Objective-C 的 +load 函数列表
